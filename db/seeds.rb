...
opinion_1 = Opinion.create!(content: "Face aux différents et profonds changements des dynamiques migratoires, le Maroc a choisi souverainement de mettre en place une nouvelle politique migratoire ", politician: politician_1, theme: theme_1)
opinion_2 = Opinion.create!(content: "le Maroc a lancé un pass vaccinal anti-Covid, le premier dans un pays du Maghreb." , politician: politician_1, theme: theme_2)
opinion_3 = Opinion.create!(content: "Le conflit au Sahara occidental est un conflit militaire qui a débuté en 1957 alors que la zone est sous contrôle espagnol. Le conflit oppose au départ le Maroc contre l'Espagne." , politician: politician_1, theme: theme_3)
opinion_4 = Opinion.create!(content: "Donald Trump annonce que le Maroc s'engage à normaliser ses relations avec Israël" , politician: politician_1, theme: theme_4)
opinion_5 = Opinion.create!(content: "Au Maroc, le gouvernement veut légaliser le cannabis « thérapeutique » Le projet de loi prévoit la création d’une « agence nationale de régulation » chargée de « développer un circuit agricole et industriel »." , politician: politician_1, theme: theme_5)
